namespace laboratoriPizzeriaCampusExpress
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
        	...
        	this.btn_Atender_Siguiente = new System.Windows.Forms.Button();
        	this.SuspendLayout();
        	// 
        	// txtCliente
        	// 
        	...
        	// 
        	// btn_Atender_Siguiente
        	// 
        	this.btn_Atender_Siguiente.Location = new System.Drawing.Point(270, 315);
        	this.btn_Atender_Siguiente.Name = "btn_Atender_Siguiente";
        	this.btn_Atender_Siguiente.Size = new System.Drawing.Size(102, 38);
        	this.btn_Atender_Siguiente.TabIndex = 9;
        	this.btn_Atender_Siguiente.Text = "Atender al siguiente";
        	this.btn_Atender_Siguiente.UseVisualStyleBackColor = true;
        	this.btn_Atender_Siguiente.Click += new System.EventHandler(this.Btn_Atender_SiguienteClick);
        	// 
        	// MainForm
        	// 
        	...
        	this.Controls.Add(this.btn_Atender_Siguiente);
        ...
        private System.Windows.Forms.Button btn_Atender_Siguiente;
    }
}